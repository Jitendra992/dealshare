...
<div className='h-full w-full overflow-x-auto custom-scrollbar py-10 px-[5%] gap-2  '>
            ...
            <div className=' flex lg:flex lg:gap-10  justify-center w-[120vw] items-center  whitespace-nowrap '>
                ...
                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738825897251Tawa.jpg'></img>
                </div>

                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738825933884Chopper.jpg'></img>
                </div>

                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738826070631SaucePan.jpg'></img>
                </div>
                ...
                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738826269527LunchBox-1.jpg'></img>
                </div>

                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738826298318FloorWiper.jpg'></img>
                </div>

                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738826331862Slicer&Grater.jpg'></img>
                </div>

                <div className='h-[10%] w-[20vw]'>
                    <img src='https://images.dealshare.in/1738826410333Casserole.jpg'></img>
                </div>
  ...
  <div className='h-full w-full overflow-x-auto custom-scrollbar  px-[5%]   '>
        ...
        <p className='text-2xl font-bold px-5 py-5'>Big Rate Drop</p>
