...
const Homepage3 = () => {
    return (<>
        ...
        <div className='lg:w-full lg:h-full overflow-x-auto custom-scrollbar lg:mb-10   '>

           <marquee scrollamount="20"
           > <div className='lg:h-[20%] h-[8%] lg:w-full flex lg:flex justify-center items-center lg:py-5   whitespace-nowrap '>
                <img className='h-24' src='https://images.dealshare.in/1737032618443WhatsAppImage2025-01-16at6.33.08PM.webp'></img>
                <img className='h-24' src='https://images.dealshare.in/1732807456060Salt1Kg_.webp'></img>
                <img className='h-24' src='https://images.dealshare.in/1732807456060Salt1Kg_.webp'></img>
            </div></marquee>
        </div>
